...
return array(
	...
	'Thank you for registration. Please check your e-mail to ensure that the registration process was successful.' => 'Дякуємо Вам за реєстрацію. Перевірте свій e-mail, щоб переконатися що реєстрація пройшла успішно',
    ...
    'Password has been sent to your email' => 'Пароль відправлен на Вашу почтову скриньку',
    ...
    'Проверьте корректность номера телефона' => 'Перевірте коректність номера телефона',
