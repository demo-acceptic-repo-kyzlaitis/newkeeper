...
<?php echo CHtml::beginForm(); ?>
	...
	<div class="rec_row">
		...
		<div class="rec_text"><?php echo UserModule::t("Пожалуйста, введите ваш логин или e-mail"); ?></div>

		<?php echo CHtml::activeTextField($form,'login_or_email',array('class'=>'mail', 'placeholder' => Yii::t('app','Введите свой e-mail'))) ?>
