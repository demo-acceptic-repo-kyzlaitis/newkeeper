...
<?php echo CHtml::beginForm(); ?>
	...
	<div class="row-form varname">
		<?php echo CHtml::activeLabelEx($model,'varname',array('class'=>'span2')); ?>
	...
	<div class="row-form title">
		<?php echo CHtml::activeLabelEx($model,'title',array('class'=>'span2')); ?>
	...
	<div class="row-form field_type">
		<?php echo CHtml::activeLabelEx($model,'field_type',array('class'=>'span2')); ?>
	...
	<div class="row-form field_size">
		<?php echo CHtml::activeLabelEx($model,'field_size',array('class'=>'span2')); ?>
	...
	<div class="row-form field_size_min">
		<?php echo CHtml::activeLabelEx($model,'field_size_min',array('class'=>'span2')); ?>
	...
	<div class="row-form required">
		<?php echo CHtml::activeLabelEx($model,'required',array('class'=>'span2')); ?>
	...
	<div class="row-form match">
		<?php echo CHtml::activeLabelEx($model,'match',array('class'=>'span2')); ?>
	...
	<div class="row-form range">
		<?php echo CHtml::activeLabelEx($model,'range',array('class'=>'span2')); ?>
	...
	<div class="row-form error_message">
		<?php echo CHtml::activeLabelEx($model,'error_message',array('class'=>'span2')); ?>
	...
	<div class="row-form other_validator">
		<?php echo CHtml::activeLabelEx($model,'other_validator',array('class'=>'span2')); ?>
	...
	<div class="row-form default">
		<?php echo CHtml::activeLabelEx($model,'default',array('class'=>'span2')); ?>
	...
	<div class="row-form widget">
		<?php echo CHtml::activeLabelEx($model,'widget',array('class'=>'span2')); ?>
		<?php 
	...
	<div class="row-form widgetparams">
		<?php echo CHtml::activeLabelEx($model,'widgetparams',array('class'=>'span2')); ?>
	...
	<div class="row-form position">
		<?php echo CHtml::activeLabelEx($model,'position',array('class'=>'span2')); ?>
	...
	<div class="row-form visible">
		<?php echo CHtml::activeLabelEx($model,'visible',array('class'=>'span2')); ?>
