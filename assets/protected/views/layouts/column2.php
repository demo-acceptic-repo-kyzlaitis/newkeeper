...
//'scroll', pos, false
					...
					$('#jcarousel-next-1').click(function() {
						...
						if (top != '-600px') { 
						//alert(top + 'ok');
						$('#jcarousel-1').jcarousel('scroll', '+=1'); }// else $('#jcarousel-1').unbind('click');
					});
...
//'scroll', pos, false
					...
					$('#jcarousel-next-2').click(function() {
						...
						if (top != '-600px') { 
						//alert(top + 'ok');
						$('#jcarousel-2').jcarousel('scroll', '+=1'); }// else $('#jcarousel-1').unbind('click');
					});
...
//'scroll', pos, false
					...
					$('#jcarousel-next-3').click(function() {
						...
						if (top != '-600px') { 
						//alert(top + 'ok');
						$('#jcarousel-3').jcarousel('scroll', '+=1'); }// else $('#jcarousel-1').unbind('click');
					});
...
//'scroll', pos, false
					...
					$('#jcarousel-next-4').click(function() {
						...
						if (top != '-600px') { 
						//alert(top + 'ok');
						$('#jcarousel-4').jcarousel('scroll', '+=1'); }// else $('#jcarousel-1').unbind('click');
					});
