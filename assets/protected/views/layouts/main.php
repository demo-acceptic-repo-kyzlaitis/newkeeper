...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?php echo Yii::app()->request->baseUrl; ?>/css/virgo/cleditor/cleditor.css" />
	...
	<link rel="stylesheet" type="text/css" href="<?php echo Yii::app()->request->baseUrl; ?>/css/jquery.placeholder.min.css" />
    ...
    /*UserModule::sendMail(
        'firebatt@ukr.net',
        UserModule::t("You registered from "),
        UserModule::t("Please activate you account go to {activation_url}",array('{activation_url}'=>'hahahah'))
    );*/
...
<div id="top-border"></div>
    <header class="header">
    	<div class="container">
    		...
    		<a href="<?php echo (Yii::app()->createUrl('/news'));?>"><img src="<?php echo Yii::app()->request->baseUrl; ?>/images/logo.png" alt="newskeeper" class="logo" /></a>
...
<?php endif; ?>
            ...
            <a href="<?php echo (Yii::app()->createUrl('/news'));?>" class="logo-min"><img src="<?php echo Yii::app()->request->baseUrl; ?>/images/logo-min.png" alt="newskeeper" /></a>
                    ...
                    <li class="two_info">
                        ...
                        <ul class="info2">
                            <div class="currency_trade">
                                ...
                                <span class="money sale"><?php $this->widget('application.components.widgets.Currency');?></span>
                                <span><?=Yii::t("app","продажа")?></span>
                                <span class="money buy"><?php $this->widget('application.components.widgets.CurSale');?></span>
                            </div>
                            <div class="valuta">
...
<?php endif; ?>
    ...
    <div id="content" class="container zoom_<?php echo NKHelper::getZoom();?>" data-zoom="<?php echo NKHelper::getZoom();?>">
    ...
    <footer class="footer">
        <div class="footer-outer container">
                ...
                <ul class="contact_copyright">
                    <li><span class="all_rights"><?php echo Yii::t("app","Все права защищены") ?> &copy; <?php echo date('Y');?> \&nbsp;</span></li>
                    <li class="about_footer_linck"><a href="<?php echo Yii::app()->createUrl("/site/contact");?>"><?php echo Yii::t("app","О нас") ?></a> \&nbsp;</li>
                    <li class="about_footer_linck"><a href="<?php echo Yii::app()->createUrl("/site/terms");?>"><?php echo Yii::t("app","Правила") ?></a></li>
                </ul>
