    ...
    // dataTable
        ...
        if($(".fTable").length > 0)
            $(".fTable").dataTable({bSort: true, 
                                    "iDisplayLength": 10, bLengthChange: false, /*"aLengthMenu": [5,10,25,50,100],*/ // can be removed for basic 10 items per page
                                    "aoColumnDefs": [{"bSortable": false,
                                                     "aTargets": [ -1 , 0]}]});
        
        if($(".fpTable").length > 0)
            $(".fpTable").dataTable({bSort: false, 
                                    "iDisplayLength": 100, bLengthChange: false, /*"aLengthMenu": [5,10,25,50,100],*/ // can be removed for basic 10 items per page
